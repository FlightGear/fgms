 ...
 * It allows flying with other pilots over a network inside \ref fgfs.
 * 
 * <table class="screenshots">
 * <tr>
 * <td><img src="MP_01.jpg"  class="gallery" height="100" alt="Credit: robitabu"></td>
 * <td><img src="flightgear-9.jpg"  class="gallery" height="100" alt="Credit: http://flightgear.en.softonic.com/images-videos"></td>
 * <td><img src="Screenshot_7.jpg"  class="gallery" height="100" alt="Credit: hellcat http://www.flightgear.org/forums/viewtopic.php?f=19&t=9022&start=30"></td>
 * <td><img src="fg-mp-1.png"  class="gallery" height="100" alt="Credit: Pigeon  http://pigeond.net/photos/flightgear/multiplay/14"></td>
 * </tr>
 * </table>
 * \note 
 ...
 * 
 * The follwing link to docs in the source.
 * \section fgms_c fgms
 * * \subpage INSTALL
 ...
 *  \include ./ChangeLog
 * 
 * \page README_tracker README.tracker
 *  \include ./contrib/fgtracker/README.tracker
 * 
